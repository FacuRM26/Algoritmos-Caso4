...
public:
    ...
    void sample(unsigned char *image)
    {
        ...
        while (placedPoint < MaxPoints)
        {
            ...
            int gray = (0.299 * red + 0.587 * green + 0.114 * blue) / 10;
            Point newPoint(randomX, randomY, gray);
    ...
    void incrementQuadrant(unsigned char *image, Quadrant *quadrant, int gray)
    {
        ...
        while (count < 5)
        {
            ...
            int gray2 = (0.299 * red2 + 0.587 * green2 + 0.114 * blue2) / 10;
            if (gray == gray2)
            {
                ...
                if (quadrant->getArea() < 2500)
                {
                    ...
                    count++;
                    Point newPoint(randomX2, randomY2, gray2);
                    points.push_back(newPoint);
                    total--;
                    placedPoint++;
                    quadrant->increasePoints();
